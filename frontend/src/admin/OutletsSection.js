  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-300 dark:border-gray-600 shadow-sm px-6 py-10 text-center text-gray-400 text-sm">No outlets yet</div>
      ) : (
        <>
          {/* Mobile cards */}
          <div className="sm:hidden space-y-3">
            {outlets.map((o) => (
              <div key={o.id} className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-300 dark:border-gray-600 shadow-sm p-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white">{o.name}</p>
                    <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold capitalize">{o.type}</span>
                  </div>
                ...
                {o.address && <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{o.address}</p>}
                {o.phone && <p className="text-xs text-gray-500 dark:text-gray-400">{o.phone}</p>}
              </div>
            ))}
          </div>

          {/* Desktop table */}
          <div className="hidden sm:block bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-300 dark:border-gray-600 shadow-sm overflow-x-auto">
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-gray-700">
                {outlets.map((o) => (
                  <tr key={o.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 dark:bg-gray-900">
                    ...
                    <td className="px-6 py-4 text-gray-600 dark:text-gray-300 text-sm whitespace-nowrap">{o.phone || "—"}</td>
